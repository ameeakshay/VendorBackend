...
categoryRouter.get('/main_categories', common.isLoggedIn, categories.get_main_categories)
categoryRouter.post('/main_categories', categories.add_main_category)
categoryRouter.get('/sub_categories/:id', common.isLoggedIn, categories.get_sub_categories)
