...
module.exports = (models, common) => {
    ...
    profile_update.get_basic_details = function(req, res) {
    ...
    profile_update.update_basic_details = function(req, res) {
    ...
    profile_update.update_business_details = function(req, res) {
    ...
    profile_update.get_business_details = function(req, res) {
